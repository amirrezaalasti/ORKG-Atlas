      ...
      >
        <Container maxWidth="md">
          ...
          <Typography variant="body1" paragraph>
            This long scrollable section mimics a layout like your dashboard.
            When you scroll down more than 100px, a floating action button (FAB)
            appears in the bottom-right corner. Clicking it will scroll you
