...
const mockQuery: Query = {
  ...
  chartSettings: {
    ...
    series: [{ label: 'empirical studies', dataKey: 'value' }],
    colors: ['#039be5'],
...
const meta: Meta<typeof QuestionAccordion> = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Expandable accordion that shows question metadata and an empirical chart view with toggles and analysis.',
      },
    },
  },
};
...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Simulates how a user would interact with the accordion to explore a charted data question.',
      },
    },
  },
};
