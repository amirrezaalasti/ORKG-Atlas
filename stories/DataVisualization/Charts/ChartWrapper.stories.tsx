...
export const BarChartDefault: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Renders a bar chart using `normalizedRatio` with full chart controls.',
      },
    },
  },
};
...
export const PieChartWithMultiSeries: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Shows a pie chart aggregating multiple series: Empirical and Non-Empirical.',
      },
    },
  },
};
